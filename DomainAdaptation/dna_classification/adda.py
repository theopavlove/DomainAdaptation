...
def main(args: argparse.Namespace):
    ...
    if args.phase == 'test' and args.pretrain is None:
        args.pretrain = logger.get_checkpoint_path('best')
    ...
    if args.phase == 'test':
        ...
        acc1 = utils.validate(test_loader, target_classifier, args, device, calc_auc=True)
        print(acc1)
        return
